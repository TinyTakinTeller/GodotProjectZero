...
const SUBSTANCE_DATA: String = "game_data/substance_data/tres"
...
var substance_datas: Dictionary = FileSystemUtils.get_resources(SUBSTANCE_DATA, true)
...
var image: Dictionary = FileSystemUtils.get_image_resources("", true)
